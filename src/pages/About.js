...
const About = () => {
  return (
    /* About Me Page */
    <section className="pagesWrapper" id="about-me">
      <div className="pages">
        <div className="homeCardLeft">
          ...
          <h3 className="text-sections">
            ...
            diving and the creativity that programming gives me. Over the years
            I have been acquainted with many different genres of academics in my
            college career including engineering, computer science, and music
            performance. I am an Eagle Scout and love the outdoors and will take
            charge in any situation as needed.
          </h3>
